...
`apply from: 'https://raw.githubusercontent.com/tangkegaga/gradle-maven-plugin/master/gradle-mavenizer.gradle'`
...
and add this line to the very bottom of the *build.gradle* file:
    ...
    apply from: "https://raw.githubusercontent.com/tangkegaga/gradle-maven-plugin/${project.mavPluginVersion}/gradle-mavenizer.gradle"`
...
project.ext {
    ...
    mavSiteUrl = "https://github.com/tangkegaga/gradle-maven-plugin"
